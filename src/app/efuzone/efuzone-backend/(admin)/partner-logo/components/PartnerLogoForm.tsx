...
import {
  ...
  uploadLogo,
  getSingleLogo,
} from "@/service/PartnerLogoService";
...
const PartnerLogoField = (): LogoFormValues[] => [
  {
    label: "Upload Logo",
    htmlfor: "upload-logo",
    fieldname: "logo",
...
function PartnerLogoForm({ id }: FormProps) {
  ...
  return (
    <>
      <form onSubmit={handleSubmit(handleUploadLogo)} id="submitPartnerLogos">
        <DynamicFormRenderer
          control={control}
          fields={FormField}
